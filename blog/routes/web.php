...
$router->delete('/removeBooking', 'Booking@removeBooking'); //刪除個人預約紀錄 ok ok
//修改預約紀錄-------------------------------------------------------------------------------------
...
//刪除各空間-------------------------------------------------------------------------------------------
$router->delete('/removeRoom',  ['middleware' => 'actions:admin', 'uses' => 'Space@removeRoom']); //刪除各空間 ok ok
//新增各空間-------------------------------------------------------------------------------------------
...
$router->delete('/deleteUser',  ['middleware' => 'actions:admin', 'uses' => 'User@deleteUser']); //刪除使用者 ok ok
